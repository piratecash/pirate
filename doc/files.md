...
`./`               | `cosanta.conf`        | Contains [configuration settings](cosanta-conf.md) for `cosantad` or `cosanta-qt`; can be specified by `-conf` option
...
These subdirectories and files are no longer used by the Cosanta Core:
