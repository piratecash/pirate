...
* cosanta.conf: contains configuration settings for cosantad or cosanta-qt
* cosantad.pid: stores the process id of cosantad while running
...
* debug.log: contains debug information and general logging generated by cosantad or cosanta-qt
