...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_21_FIRST_POS_BLOCK,               4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_22_FIRST_POS_V2_BLOCK,            4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_23_LAST_POW_BLOCK,                4070908800ULL), // OFF
};
