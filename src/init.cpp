...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by PirateCash Platform, to the specified username.", false, OptionsCategory::MASTERNODE);
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    // ********************************************************* Step 10c: schedule PirateCash-specific tasks
