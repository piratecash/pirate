...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<cosanta_address>", strprintf(_("Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.")), false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", _("Set the username for the \"platform user\", a restricted user intended to be used by Cosanta Platform, to the specified username."), false, OptionsCategory::MASTERNODE);
...
#ifdef ENABLE_WALLET
    gArgs.AddArg("-staking=<n>", strprintf(_("Enable staking functionality (0-1, default: %u)"), 1), false, OptionsCategory::POS);
    gArgs.AddArg("-reservebalance=<amt>", _("Keep the specified amount available for spending at all times (default: 0)") false, OptionsCategory::POS);
    gArgs.AddArg("-stakesplitthreshold=<n>", strprintf(_("Splits stake reward by threshold (default: %d)"), DEFAULT_STAKE_SPLIT_THRESHOLD) false, OptionsCategory::POS);
    gArgs.AddArg("-stakemaxsplit=<n>", strprintf(_("Sets the number of max inputs & outputs of a stake (default: %d)"), DEFAULT_STAKE_MAX_SPLIT) false, OptionsCategory::POS);
    gArgs.AddArg("-stakeautocombine=<n>", strprintf(_("Autocombine feature: 0 - disable, 1 - same account, 2 - any account (default: %d)"), DEFAULT_STAKE_AUTOCOMBINE) false, OptionsCategory::POS);
#endif
    gArgs.AddArg("-gen", strprintf(_("Generate coins (default: 0)")) false, OptionsCategory::POW);
    gArgs.AddArg("-genproclimit", strprintf(_("processors, -1 is unlimited. (default: -1)")) false, OptionsCategory::POW);
}
