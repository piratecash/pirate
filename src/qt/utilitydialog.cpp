    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  cosanta-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        strUsage += HelpMessageOpt("-windowtitle=<name>", _("Sets a window title which is appended to \"Cosanta Core - \""));
...
These denominations are 0.001 COSANTA, 0.01 COSANTA, 0.1 COSANTA, 1 COSANTA and 10 COSANTA -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.dash.org/en/stable/wallets/cosantacore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
