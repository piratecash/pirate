...
std::string GetHelpString(int nParamNum, std::string strParamName)
{
    static const std::map<std::string, std::string> mapParamHelp = {
        ...
        {"ownerAddress",
            "%d. \"ownerAddress\"             (string, required) The cosanta addressg to use for payee updates and proposal voting.\n"
...
// Allows to specify Cosanta address or priv key. In case of Cosanta address, the priv key is taken from the wallet
